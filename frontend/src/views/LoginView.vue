  ...
  <div class="section">
    <div class="container">
      <div class="wrap">
        <div class="card">
          <div class="head">
            <div class="h1">读者登录</div>
            <div class="muted sub">学号/密码登录 · 登录状态保存在 localStorage</div>
          </div>
          ...
          <form class="form" @submit.prevent="submit">
            ...
            <button class="btn" type="button" @click="router.push({ path: '/register', query: { redirect: redirect } })">
              没有账号？去注册
            </button>
          </form>
        </div>
